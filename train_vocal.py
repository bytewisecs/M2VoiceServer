...
if __name__ == "__main__":
    # 第一轮：只改变Vocal输入表示，其他设置完全一致。
    # magnitude是原始基线；另外三个版本用于检查复数相位/IQ信息。
    experiments = [
        {
            "name": "vocal_magnitude",
            "modality": "vocal",
            "vocal_representation": "magnitude",
        },
        {
            "name": "vocal_phase",
            "modality": "vocal",
            "vocal_representation": "phase",
        },
        {
            "name": "vocal_phase_diff",
            "modality": "vocal",
            "vocal_representation": "phase_diff",
        },
        {
            "name": "vocal_real_imag",
            "modality": "vocal",
            "vocal_representation": "real_imag",
        },
        {
            "name": "vocal_magnitude_phase",
            "modality": "vocal",
            "vocal_representation": "magnitude_phase",
        },
    ]
    ...
    ablation_summary_path = "vocal_representation_summary.csv"
    with open(
