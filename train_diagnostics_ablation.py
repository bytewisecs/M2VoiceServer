...
def train(modality="fusion"):
    ...
    checkpoint_dir = f"checkpoints_text_cls_split2_v2_{modality}"
...
if __name__ == "__main__":
    # 步骤1和步骤2只检查融合模型时，改为：["fusion"]
    # 步骤3进行完整消融时，使用下面三个实验。
    experiment_modalities = ["lip", "vocal", "fusion"]
    ...
    ablation_summary_path = "ablation_summary.csv"
    with open(
